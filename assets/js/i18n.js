  ...
  var messages = {
    ar: {
      ...
      preview: {
        ...
        greeting: "صباح الخير 👋",
        userName: "أحمد",
        nextLabel: "موعدك القادم",
        nextWhen: "خلال ٢٠ دقيقة",
        doctorName: "د. سارة عبد الله",
        doctorSpec: "طب باطني · استشارية",
        rating: "٤٫٩",
        reviews: "(١٢٤)",
        cta: "ابدأ المكالمة",
        activityLabel: "نشاط حديث",
        activityRx: "صُرفت وصفتك من صيدلية الشفاء",
        activityRxTime: "قبل ٥ دقائق",
        floaterBooked: "حجز جديد",
        floaterVerified: "تم التحقق",
        floaterOnline: "٢٠٠ طبيب متصل",
      },
      ctaBand: {
    ...
    en: {
      ...
      preview: {
        ...
        userName: "Ahmad",
        nextLabel: "Your next appointment",
        nextWhen: "in 20 min",
        ...
        activityRx: "Your prescription was dispensed at Al-Shifa Pharmacy",
        activityRxTime: "5 min ago",
        floaterBooked: "New booking",
        floaterVerified: "Verified",
        floaterOnline: "200 doctors online",
      },
      ctaBand: {
